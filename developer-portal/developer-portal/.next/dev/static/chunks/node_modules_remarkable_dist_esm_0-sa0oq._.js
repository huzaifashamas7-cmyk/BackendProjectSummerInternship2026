...
"[project]/node_modules/remarkable/dist/esm/index.browser.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ rules.fence = function(tokens, idx, options, env, instance) {
    ...
    if (options.highlight) {
        highlighted = options.highlight.apply(options.highlight, [
            token.content
        ].concat(fences)) || escapeHtml(token.content);
    } else {
...
function smartquotes(state) {
    /*eslint max-depth:0*/ var i, token, text, t, pos, max, thisLevel, lastSpace, nextSpace, item, canOpen, canClose, j, isSingle, blkIdx, tokens, stack;
    if (!state.options.typographer) {
        return;
    }
    stack = [];
...
var single_quoted = /'[^']*'/;
var double_quoted = /"[^"]*"/;
/*eslint no-spaced-func:0*/ var attr_value = replace$1(/(?:unquoted|single_quoted|double_quoted)/)('unquoted', unquoted)('single_quoted', single_quoted)('double_quoted', double_quoted)();
...
"[project]/node_modules/remarkable/dist/esm/linkify.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$autolinker$2f$dist$2f$es2015$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/autolinker/dist/es2015/index.js [app-client] (ecmascript) <locals>");
;
...
function createLinkifier() {
    var links = [];
    var autolinker = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$autolinker$2f$dist$2f$es2015$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"]({
        stripPrefix: false,
        url: true,
        email: true,
        replaceFn: function(match) {
            ...
            switch(match.getType()){
                /*eslint default-case:0*/ case 'url':
                    links.push({
...
//# sourceMappingURL=node_modules_remarkable_dist_esm_0-sa0oq._.js.map